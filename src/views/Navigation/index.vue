<template>
	...
	<van-row >
	  ...
	  <van-col span="24" class="item" v-for="(item,index) in list" :key="item.id" @click="toListPage(item.id,item.name)" >{{item.name}}</van-col>
	</van-row>
	<!-- 学校概况↑ -->
</template>
